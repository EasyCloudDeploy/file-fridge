...
from app.models import FileRecord, MonitoredPath, OperationType
        ...
        try:
            ...
            for file_record in file_records:
                try:
                    ...
                    error_msg = f"Error reversing {file_record.original_path}: {str(e)}"
            ...
            error_msg = f"Error during path reversal: {str(e)}"
            results["errors"].append(error_msg)
            logger.error(error_msg)
            db.rollback()
